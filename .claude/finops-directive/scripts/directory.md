# Directory: .claude/finops-directive/scripts/

## Purpose

Deterministic execution tools scoped to the finops directive (Layer 3).
...
`finops.md` under the Execution > Scripts table.
