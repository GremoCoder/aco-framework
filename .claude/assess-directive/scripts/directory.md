# Directory: .claude/assess-directive/scripts/

## Purpose

Deterministic execution tools scoped to the assess directive (Layer 3).
...
`assess.md` under the Execution > Scripts table.
